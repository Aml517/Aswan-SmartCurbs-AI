...
INPUT_VIDEO = Path("ai/vehicle_detection/data/input.mp4")
...
if __name__ == "__main__":
    ...
    CONFIG = {
        "input": "ai/vehicle_detection/data/input.mp4",
        "output": "ai/vehicle_detection/outputs/vehicle_detection_output.mp4",
        "model": "yolov8n.pt"
    }
